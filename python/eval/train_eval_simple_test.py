...
##    c10a = c10a.astype(np.int32) * nm + n
    ...
    with tf.device('/GPU:0'):
        ...
        d2c = Embedding(input_dim=cor9.max()+1, output_dim=E1, mask_zero=False, name='c9', embeddings_regularizer=tf.keras.regularizers.L2(L2))(i3) # 4
        d3c = Tr23()(MySum()(d2c))
        ...
        d3 = Concatenate()([d3c, d3d, d3e, d3f, d3g, d3h, d3i, d3j, d3k, d3l, d3c8, d3m]) # E1x14
...
# E1=16:            39.0 need to incr L2, repeat samples for n+-1
# remove xN:        34.6
